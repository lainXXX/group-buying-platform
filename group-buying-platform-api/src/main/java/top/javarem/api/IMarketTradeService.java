...
public interface IMarketTradeService {
    ...
    /**
     * 结算订单
     * @param settleMarketPayOrderRequestDTO 支付成功请求对象
     * @return boolean
     */
    Response<SettleMarketPayOrderResponseDTO> settlePayOrder(SettleMarketPayOrderRequestDTO settleMarketPayOrderRequestDTO);
